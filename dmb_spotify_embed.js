...
* @returns {Promise<any>}
*/
export function get_now_playing_obj() {
    const ret = wasm.get_now_playing_obj();
...
* @returns {Promise<any>}
*/
export function get_now_playing_analysis_wrapper() {
    const ret = wasm.get_now_playing_analysis_wrapper();
    return takeObject(ret);
}
...
* @returns {Promise<any>}
*/
export function update_wrapper() {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('dmb_spotify_embed_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
